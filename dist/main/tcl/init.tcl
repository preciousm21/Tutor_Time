...
proc tcl::DarwinFixAutoPath {} {
    if {[lsearch -exact $::auto_path /System/Library/Tcl/8.5] == -1 && [lsearch -exact $::auto_path /System/Library/Tcl] != -1} {
	foreach g {::auto_path ::tcl_pkgPath} {
	    set $g [linsert [set $g] [expr {[lsearch -exact [set $g] /System/Library/Tcl]+1}] /System/Library/Tcl/8.5]
	}
    }
}
tcl::DarwinFixAutoPath
rename tcl::DarwinFixAutoPath {}
